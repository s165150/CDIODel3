...
public class GameBoard {
	...
	{
		boardFields.add(new Territory("Tribe Encampment", "A vild and primitive place", "1000", "icons/Tribe_Encampment.png", Color.WHITE, 10, 1000, 100));
		boardFields.add(new Territory("Crater", "Is there even a bottom?", "1500", "icons/Crater.png", Color.WHITE, 10, 1500, 300));
		boardFields.add(new Territory("Mountain", "Taller than the eye can see!", "2000", "icons/Mountain.png", Color.WHITE, 10, 2000, 500));
		boardFields.add(new Territory("Cold Desert", "A vast and endless desert of ice", "3000", "icons/Cold_Desert.png", Color.WHITE, 10, 3000, 700));
		boardFields.add(new Territory("Black Cave", "I wonder what awaits everyone who dare enter", "4000", "icons/Black_Cave.png", Color.WHITE, 10, 4000, 1000));
		...
		boardFields.add(new LaborCamp("Hut In The Mountain", "A settlement of savages", "2500", "icons/Huts_In_The_Mountain.png", Color.PINK, 10 , 2500, 100));
		boardFields.add(new LaborCamp("The Pit", "A vast slavecamp", "2500", "icons/Pit.png", Color.PINK, 10, 2500, 100));
		...
		boardFields.add(new Fleet("Second Sail", "A major corvette, ment for escorting tradeships", "4000", "icons/Second_Sail.png", Color.CYAN, 10, 4000));
		boardFields.add(new Fleet("Sea Grover", "A large trading ship!", "4000", "icons/Sea_Grover.png", Color.CYAN, 10, 4000));
		boardFields.add(new Fleet("The Buccaneers", "A fleet of small raiding ships", "4000", "icons/The_Buccaneers.png", Color.CYAN, 10, 4000));
		boardFields.add(new Fleet("Privateer Armada", "A fleet of warships, ment for procection of the realm.", "4000", "icons/Privateer_Armada.png", Color.CYAN, 10, 4000));
	}
	...
	for(int i = 0; i < numOfPlayers; i++)
	{
	    ...
	    Player plr = new Player(name, i, 0);
	    playerList.add(plr);
