...
public class ShakerTestFrequency {
	...
	public void testShaker() 
	{
		...
		assertEquals(9000,two,700);
		assertEquals(18000,three,900);
		assertEquals(27000,four,900);
		assertEquals(36000,five,1100);
		assertEquals(45000,six,1400);
		assertEquals(54000,seven,1600);
		assertEquals(45000,eight,1400);
		assertEquals(36000,nine,1100);
		assertEquals(27000,ten,900);
		assertEquals(18000,eleven,900);
		assertEquals(9000,twelve,700);
